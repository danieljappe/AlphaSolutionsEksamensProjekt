...
public class Repository {
    private final DatabaseConnectionManager dcm = new DatabaseConnectionManager("eu-west.connect.psdb.cloud", "djsijyrbrtyyhx4a7cq3", "pscale_pw_vc2Kj1cyvQ4hGHXMMSdr8jYMcBpXTyGxoAKpJwgRF2E");
