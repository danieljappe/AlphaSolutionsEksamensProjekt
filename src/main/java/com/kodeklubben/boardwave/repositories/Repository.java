...
public class Repository {
    private final DatabaseConnectionManager dcm = new DatabaseConnectionManager("eu-west.connect.psdb.cloud", "5l313oh35qxevjkt2lnb", "pscale_pw_PHuH0zelYz3zrCEdtcWwHRJJESgzZyJ9fkX47Ah65e9");
