...
public class Repository {
    private final DatabaseConnectionManager dcm = new DatabaseConnectionManager("eu-west.connect.psdb.cloud", "irjrgw0cvpjv23xjf6ye", "pscale_pw_biSwOMnWjOBSHkIDzapyFYxXPL8UhWMYEk0XWextPBC");
