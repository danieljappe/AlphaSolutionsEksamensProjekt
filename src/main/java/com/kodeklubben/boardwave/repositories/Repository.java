...
public class Repository {
    private final DatabaseConnectionManager dcm = new DatabaseConnectionManager("eu-west.connect.psdb.cloud", "x2mww1nix1o73pxcb98c", "pscale_pw_4sPH0oXrUgqz61ws7Cacjbk27pw1IN7bJfKxcX8Uyxb");
